...
- **Knowledge Graph UI** (`ui/monitoring/`): página de grafo interativo no painel de
  monitoramento — nós por agente, arestas por delegação, painel de detalhes ao clicar.
