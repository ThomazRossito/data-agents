...
class FabricClient:
    ...
    async def _request(
        ...
        *,
        ...
        for attempt in range(3):
            ...
            raise RuntimeError(f"Fabric API error {resp.status_code}: {error}")
    ...
    async def create_ontology(
        ...
        result = await self._request(
            "POST", f"/workspaces/{workspace_id}/ontologies", json_body=body
        )
        return result or {}
    ...
    async def get_ontology_definition(self, workspace_id: str, ontology_id: str) -> dict:
    ...
    async def get_kql_database(self, workspace_id: str, kql_database_id: str) -> dict:
